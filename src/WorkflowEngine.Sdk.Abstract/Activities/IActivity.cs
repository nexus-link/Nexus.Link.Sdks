...
/// </summary>
/// <param name="activity">The current activity of type <typeparamref name="TActivity"/>.</param>
...
public interface IActivity : IActivityBase, IWorkflowLogger
{
    ...
    /// <summary>
    /// If the activity has failed, this will return the exception, otherwise it will return null.
    /// </summary>
    ActivityFailedException GetException();
}