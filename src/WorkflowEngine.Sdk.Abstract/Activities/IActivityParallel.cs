...
/// </summary>
public interface IActivityParallel : IExecutableActivity<JobResults>
{
    /// <summary>
    ...
    /// The <paramref name="index"/> should be > 0 and unique for this job within the parallel activity. It can be used to find the result using <see cref="JobResults.Get{IActivityParallel}"/>
    /// </summary>
