...
namespace AsyncCaller.Sdk.UnitTests
{
    ...
    public class EnvelopeTests
    {
        ...
        [TestMethod]
        public async Task LatestResponseWithCommaInServerHeaderLastIsOk()
        {
            const string content = "HTTP/1.1 504 Gateway Time-out\r\n" +
                                   "Date: Thu, 28 Jan 2021 13:34:50 GMT\r\n" +
                                   "Connection: keep-alive\r\n" +
        ...
        [TestMethod]
        public async Task LatestResponseWithCommaInServerHeaderAndExpiresMinusOneIsOk()
        {
            const string content = "HTTP/1.1 504 Gateway Time-out\r\n" +
                                   "Expires: -1\r\n" +
                                   "Date: Thu, 28 Jan 2021 13:34:50 GMT\r\n" +
        ...
        [TestMethod]
        public async Task LatestResponseWithCommaInServerHeaderAndExpiresMinusOneLastIsOk()
        {
            const string content = "HTTP/1.1 504 Gateway Time-out\r\n" +
                                   "Date: Thu, 28 Jan 2021 13:34:50 GMT\r\n" +
                                   "Connection: keep-alive\r\n" +
