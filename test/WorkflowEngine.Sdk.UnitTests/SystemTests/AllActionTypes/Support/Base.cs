...
public abstract class Base
{
    ...
    protected Mock<IAllActivityTypesLogic> LogicMoq { get; }
    ...
    protected Base(string name)
    {
        ...
        WorkflowContainer = new AllActivityTypesContainer(workflowCapabilities);
        LogicMoq = new Mock<IAllActivityTypesLogic>();
        WorkflowContainer.AddImplementation(new AllActivityTypesImplementation(WorkflowContainer, LogicMoq.Object));
