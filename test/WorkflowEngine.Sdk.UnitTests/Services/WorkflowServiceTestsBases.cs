...
public abstract class WorkflowServiceTestsBases
{
    ...
    protected static readonly IWorkflowEngineStorage WorkflowEngineStorage = new WorkflowEngineStorageMemory();

    static WorkflowServiceTestsBases()
    {
        var asyncRequestMgmtCapabilityMock = new Mock<IAsyncRequestMgmtCapability>();
        WorkflowSummaryService = new WorkflowSummaryService(ConfigurationTables, RuntimeTables);
